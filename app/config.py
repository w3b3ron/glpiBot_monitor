...
MTTR_HIGH_THRESHOLD_HOURS = int(os.getenv("MTTR_HIGH_THRESHOLD_HOURS", 24))
INSIGHT_VARIATION_THRESHOLD = int(os.getenv("INSIGHT_VARIATION_THRESHOLD", 20))
RANKING_SCHEDULE_DAY = os.getenv("RANKING_SCHEDULE_DAY", "monday").strip().lower()
RANKING_SCHEDULE_TIME = os.getenv("RANKING_SCHEDULE_TIME", "08:00").strip()
